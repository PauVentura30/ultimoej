...
export function Ofertas() {
 ...
 // Array de datos de productos en oferta con información completa
 const ofertasData = [
   {
     id: 5,
     name: "Nike Air Mag",
   ...
   },
   {
     ...
     rating: 4.7,
     reviews: 215,
     image: "/img/lilnas.webp",
     endDate: "2025-06-30",
     isLimitedTime: true
   }
 ];

 // Función para calcular días restantes hasta que termine la oferta
 ...
 return (
   <div className="container py-5">
     ...
     {/* Banner promocional principal con imagen de fondo */}
     <div 
       className="card border-0 shadow-lg mb-5 text-white overflow-hidden position-relative" 
       style={{ 
         height: '300px',
         backgroundImage: 'url(/img/imgbannerofertas.webp)',
     ...
     >
       <div className="row g-0 h-100">
         {/* Espacio para imagen en desktop */}
     ...
     {/* Estilos CSS personalizados para las tarjetas de ofertas */}
     <style>
       {`
         .offer-card {
     ...
     {/* Grid responsivo de productos en oferta */}
         ...
         <div key={oferta.id} className="col-md-6 col-lg-4 col-xl-3 mb-4">
           <div className="card offer-card border-0 shadow-sm">
             <div className="position-relative">
               ...
               {/* Badge de tiempo limitado condicional */}
               ...
               {/* Badge con días restantes de la oferta */}
             ...
             <div className="card-body offer-body">
               ...
               {/* Footer con precios y botón de compra */}
